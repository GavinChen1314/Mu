...
#if !defined(__GLIBC__) || (__GLIBC__ < 2) || ((__GLIBC__ == 2) && (__GLIBC_MINOR__ < 23))
	destorage = (struct dirent*)jemalloc(sizeof(struct dirent)+pathconf(mp,_PC_NAME_MAX)+1);
	passert(destorage);
#endif
