...
#else
			GLUE_HASH_TAB_PREFIX(hashtab)[GLUE_HASH_TAB_PREFIX(rehashpos) >> HASHTAB_LOBITS] = jemalloc(sizeof(ENTRY_TYPE*)*HASHTAB_LOSIZE);
#endif
...
#else
			GLUE_HASH_TAB_PREFIX(hashtab)[i] = jemalloc(sizeof(ENTRY_TYPE*)*HASHTAB_LOSIZE);
#endif
